    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: _style2.default.TodoApp },
...
// module
exports.push([module.i, "._3oXqS-LOv7qpb2a0HWWfk {\n    background-color: #F5F5F5;\n    color: #222;\n    display: flex;\n    flex-direction: column;\n    flex-wrap: nowrap;\n    justify-content: center;\n    align-items: center;\n    align-content: center;\n    width: 100vw;\n    height: 100vh;\n}", ""]);

// exports
exports.locals = {
	"TodoApp": "_3oXqS-LOv7qpb2a0HWWfk"
};
...
var TodoList = function TodoList(props) {
	var todoListElements = props.list.map(function (element) {
		return _react2.default.createElement(
			"li",
			{ key: element.id, id: element.id, onClick: function onClick() {
					return props.remove(element.id);
				} },
			" ",
			element.text,
			" "
